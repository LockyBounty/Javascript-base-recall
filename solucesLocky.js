...
var titleize = function (string) {
    ...
    let c = b.join(' ');
    // d = c.charAt(0).toUpperCase(c.match(regx))+c.substring(1, c.length); // mettre le premier char en maj.

    //fonction pour mettre en majuscule les premiers caracteres a chaque debut de phrase.
